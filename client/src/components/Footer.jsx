...
function Footer() {
  return (
    <footer className=" bottom-0  bg-gray-900 text-gray-300 w-full">
      <div className="container mx-auto border-t border-gray-600 md:py-4 py-2 flex flex-wrap justify-center">
        <div className="w-full sm:w-1/2  md:w-5/12 lg:w-1/3 md:p-4 p-2">
          ...
          <ul className="space-y-2 ">
            ...
            <Link
              to="https://www.google.com/maps/place/NutriCe+Almac%C3%A9n+Natural/@-34.4538975,-58.7966185,21z/data=!4m6!3m5!1s0x95bc9fad7bb3f279:0xa8bf1b508b1f0156!8m2!3d-34.4539099!4d-58.7966558!16s%2Fg%2F11twg6441z?entry=ttu"
              target="_blank"
            >
        ...
        <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 md:p-4 p-2">
          ...
          <ul className="space-y-2">
            <Link
              to="https://www.instagram.com/nutricealmacen/"
              target="_blank"
            >
