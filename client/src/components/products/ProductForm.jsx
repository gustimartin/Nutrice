  ...
  return (
    <div className=" ">
      ...
      >
        ...
        <div>
          <h1 className=" text-zinc-800 text-3xl ">Agregar Producto</h1>
        </div>
        ...
        <textarea
          ...
          id="message"
          rows="4"
          className="block p-2.5 w-full text-sm border-0 border-b-2 text-gray-900 bg-transparent  rounded-sm  border-gray-300 focus:ring-purple-800 focus:border-purple-800 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
